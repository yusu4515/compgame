...
- **ストーリー×クイズ統合**: 物語の途中でクイズが発生し、正解で道が開く演出
- **ドラクエ風UI/UX**: コマンド選択・クリック進行・明度/彩度調整
- **ATB演出**: 制限時間とHPで緊張感を演出
- **Slack連携**: ログイン/レベルアップ/称号/週次TOP3/号外通知
...
- `weekly_rankings`
- `slack_events`
- `quest_scripts` : 物語テキスト格納
- `items` : 属性装備/ヒントアイテム
- `town_prosperity` : 復興度管理
